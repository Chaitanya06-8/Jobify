        ...
        <div className="container max-w-6xl mx-auto">
          <div className="flex flex-wrap">
           ...
           className="mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-stroke text-dark 
              hover:border-primary hover:bg-primary hover:text-white dark:border-dark-3 dark:text-white 
             dark:hover:border-primary sm:mr-4 lg:mr-3 xl:mr-4">
                 ...
                 <svg width="8"height="16"viewBox="0 0 8 16"className="fill-current">
                  ...
                  >
                    <svg
                      width="16"height="12"viewBox="0 0 16 12"className="fill-current">
                  ...
                  >
                    <svg
                      width="14" height="14"viewBox="0 0 14 14"className="fill-current">
